...
const Advantages = () => {
  const advantages = [
    ...
    },
    {
      ...
      details: 'רישיונות מקצועיים, הכשרות מתמשכות, ניסיון רב שנים וידע עדכני בתחום',
      color: 'from-indigo-500 to-indigo-600'
    },
    {
      icon: Heart,
      title: 'מאות בניינים מרוצים',
      description: 'אמון שנבנה לאורך שנים',
      details: 'בניינים רבים בניהול, המלצות מעולות מדיירים והערכה גבוהה מועדי בתים',
        ...
        >
          <div className="bg-primary-600 text-white rounded-2xl p-8 shadow-xl">
            ...
            <p className="text-primary-100 mb-6 max-w-2xl mx-auto">
              בניינים רבים כבר נהנים מהשירות שלנו. הגיע הזמן שגם אתם תחוו ניהול מבנים כמו שצריך.
            </p>
